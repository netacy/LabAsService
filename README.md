...
Un exemple de configuration est disponible ici [Exemple de config](nodes/sw-wifi/config.txt). Il conviendra d'adapter l'adresse IP de management et les identifiants de connexion SNMP et les personnalisant un peu ces valeurs...
