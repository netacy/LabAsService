...
do
	...
	echo "auto $nic.$vni"
	echo "iface $nic.$vni inet manual"
	echo "post-up ip link add link $nic $nic.$vni type vlan proto 802.1ad id $vni"
	...
	echo "bridge_ports vxlan$vni $nic.$vni"
	echo "bridge_stp off"
